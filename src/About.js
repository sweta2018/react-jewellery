                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="icon-box">
                          <div className="icon-circle"><img src="abt1.png"/></div>
                          <div className="icon-text">100% Custom-Made Jewelry</div>
                        </div>
                        <div className="icon-box">
                          <div className="icon-circle"><img src="abt2.png"/></div>
                          <div className="icon-text">Certified Diamonds</div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="icon-box">
                          <div className="icon-circle"><img src="abt3.png"/></div>
                          <div className="icon-text">Internal Quality Tested</div>
                        </div>
                        <div className="icon-box">
                          <div className="icon-circle"><img src="abt4.png"/></div>
